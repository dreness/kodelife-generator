...
Will validate GLSL source code using the Khronos Group's reference shader compiler implementation [glslang](https://github.com/KhronosGroup/glslang). This is an experimental feature and currently only available for OpenGL API configurations.
